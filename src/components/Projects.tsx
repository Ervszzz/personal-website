...
const filters = Object.keys(TAG_DISPLAY);
...
const Projects = () => {
  ...
  return (
    <section id="projects" className="py-20 bg-tech-gray-dark relative overflow-hidden">
            ...
            >
              <div className="relative overflow-hidden">
                <img
                  src={project.image}
                  alt={project.title}
                  className={`w-full ${project.featured ? "h-64 md:h-80" : "h-48"} object-cover transition-transform duration-500 group-hover:scale-105`}
                />
                {project.featured && (
              ...
              <div className="p-6">
                <h3 className="text-xl font-tech font-semibold text-tech-cyan mb-2">{project.title}</h3>
          ...
          <div className="bg-tech-gray-dark/80 backdrop-blur-sm border border-tech-purple/40 rounded-none overflow-hidden transition-all duration-300 hover:shadow-neon-purple hover:border-tech-purple/60 group">
            <div className="p-6 flex flex-col items-center justify-center min-h-[300px] relative">
              <div className="absolute inset-0 overflow-hidden opacity-10">
                ...
                <div className="absolute top-3/4 right-1/4 w-3 h-3 bg-tech-cyan rounded-full animate-pulse" style={{ animationDelay: "0.5s" }}></div>
                <div className="absolute top-1/2 left-1/2 w-4 h-4 bg-tech-pink rounded-full animate-pulse" style={{ animationDelay: "1s" }}></div>
                <div className="absolute top-1/3 right-1/3 w-2 h-2 bg-tech-teal rounded-full animate-pulse" style={{ animationDelay: "1.5s" }}></div>
              </div>

              <div className="w-20 h-20 mb-6 relative">
                <div className="absolute inset-0 bg-tech-purple/20 rounded-full animate-ping opacity-75"></div>
                <div className="relative w-full h-full flex items-center justify-center text-4xl">🛠️</div>
              </div>
              ...
              <p className="text-tech-light/80 mb-6 text-center max-w-md">
                I'm currently working on several exciting new projects that will be showcased here soon.
              ...
              <p className="text-tech-purple/80 text-sm font-tech">Building in progress...</p>
            </div>
          </div>
        </div>
      </div>
